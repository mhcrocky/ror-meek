...
var batchedUpdates = ReactDOM.unstable_batchedUpdates || function (fn) {
  return fn();
};
...
function (_React$PureComponent) {
  ...
  Form.getDerivedStateFromProps = function getDerivedStateFromProps(_ref3, _ref4) {
    ...
    if (value !== formState.value || touched !== formState.touched || !shallowequal(formState.errors, errors)) return {
  ...
  _proto.render = function render() {
    ...
    var props = omit(this.props, YUP_OPTIONS.concat(Object.keys(Form.propTypes), ['onTouch']));
    ...
    if (Element === null || Element === false) {
      ...
      children = React.createElement(Element, props, children);
    }

    return React.createElement(BindingContext, {
      value: value,
      getter: getter,
      setter: setter,
      onChange: this.handleChange
    }, React.createElement(FormActionsContext.Provider, {
      value: this.formActions
    }, React.createElement(FormDataContext.Provider, {
...
var ControlledForm = uncontrollable(Form, {
  value: 'onChange',
  errors: 'onError',
  touched: 'onTouch'
});
